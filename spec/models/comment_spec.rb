...
RSpec.describe Comment, type: :model do
  it 'add some examples to (or delete)' do
    author = User.new(name: 'Mandy', email: 'mandy@test.com', password: 'mandymandy', photo: '', bio: '', posts_counter: 0)
    author.skip_confirmation!
    post = Post.new(title: 'Frustrating...', text: 'I haven\'t completed things...', author: author)
    post.save!

    comment_creator = User.new(name: 'Mike', email: 'mike@test.com', password: 'mike123', photo: '', bio: '', posts_counter: 0)
